    ...
    await queryInterface.bulkInsert("events", [
      {
        ...
        admin_id: 1,
        price: 140,
        start: new Date("2024-04-06T16:00:00"),
        end: new Date("2024-04-06T18:00:00"),
        status_id: 2,
        capacity: 10,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end: new Date("2024-04-15T20:00:00"),
        status_id: 2,
        capacity: 15,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        admin_id: 2,
        price: 0,
        start: new Date("2024-04-16T20:00:00"),
        end: new Date("2024-04-16T22:00:00"),
        status_id: 2,
        capacity: 15,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        admin_id: 3,
        price: 40,
        start: new Date("2024-04-09T10:00:00"),
        end: new Date("2024-04-09T15:00:00"),
        status_id: 3,
        capacity: 15,
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        admin_id: 6,
        price: 140,
        start: new Date("2024-04-12T10:00:00"),
        end: new Date("2024-04-12T16:00:00"),
        status_id: 2,
        capacity: 9,
        created_at: new Date(),
        updated_at: new Date(),
